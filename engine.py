...
'''Stores a return value and its associated metadata.'''
class Retval:
    def __init__(self, value, depth, in_loop, in_conditional, is_var, token_str, is_callexpr, is_enum):
        self.value = value
        self.depth = depth
        self.in_loop = in_loop
        self.in_conditional = in_conditional
        self.is_var = is_var
        self.is_callexpr = is_callexpr
...
'''Represents a function contained in the header file of an api:
    ...
    -retValues is a list of Retval objects. Retval objects are (for now, constant) return values that the function may return, with their associated metadata.'''
...
class CheckCompatibility:
    ...
    def determine_enum_status(self, enum_name):
        ...
        failureKeywords = ["UNSUCCESS", "INVALID", "ERROR", "NOTOK", "FAIL", "NULL", "DISALLOWED"]
        value = None
        currcomparison = None
